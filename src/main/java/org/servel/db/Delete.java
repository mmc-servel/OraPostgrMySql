...
public class Delete  extends Thread {
    ...
    public Delete(java.sql.Connection conn, int thread_id,int durationMin) {
    ...
    public void run() {
        try {
            System.out.println("Delete thread " + thread_id + " started");
            PreparedStatement statement = conn.prepareStatement("delete from product_items where product_id=?");
            ...
            System.out.println("Delete th= " + thread_id + " End. Count="+count);
